        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit </span> </h4>
                    ...
                    <div class="card-body">
                      ...
                      <form method="POST" action="change-password.php">
                        <div class="mb-3">
                          ...
                          <input type="hidden" class="form-control" id="id" name="id" value="<?= $_SESSION["id"]; ?>" placeholder=""  required/>
