            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                  <div class="card" style="height:75vh; background-image: url('assets/img/backgrounds/bg.jpg'); background-size: cover;">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-12">
                        <div class="card-body text-center mt-5">
                          <h1 class="card-title text-primary">Selamat datang di <br>SISLAUNDRY</h1>
