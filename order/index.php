                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="" class="btn rounded-pill btn-icon btn-info">
                            <span class="tf-icons bx bxl-whatsapp"></span>
                          </a>
                        </td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="edit.php?id=<?= $data['id']; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item alert_notif" href="delete.php?id=<?= $data['id']; ?>"
                                ><i class="bx bx-trash me-1"></i> Delete</a
                              >
                              <a class="dropdown-item" href="nota.php?id=<?= $data['id']; ?>"
                                ><i class="bx bx-trash me-1"></i> Cetak Nota</a
                              >
                            </div>
                          </div>
                        </td>
